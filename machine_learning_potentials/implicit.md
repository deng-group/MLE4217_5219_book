...
## Unified Features
You can also combine explicit and implicit features to get the best of both worlds. The idea is to use explicit descriptors or basis expansions to capture the local atomic environment and then use a learnable model to map those representations to energies and forces. This approach can improve the accuracy and efficiency of MLPs. Some architectures are closer to this hybrid philosophy than others. For example, MACE uses ACE-inspired equivariant basis functions together with learnable message passing. By contrast, models such as [SchNet](https://doi.org/10.48550/arXiv.1706.08566), [PhysNet](https://doi.org/10.1021/acs.jctc.9b00181), and [GemNet](https://doi.org/10.48550/arXiv.2106.08903) are more naturally described as learned message-passing architectures rather than simple explicit-descriptor-plus-network pipelines.
