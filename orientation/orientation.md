...
https://libguides.nus.edu.sg/new2nus/acadintegrity), particularly section about AI tools.
- You must obey to law of Singapore and [Code of Conduct for student](https://studentconduct.nus.edu.sg/wp-content/uploads/NUS-Code-of-Student-Conduct.pdf). 
- You must not use to university HPC services for other personal interest such as Bitcoin mining and obey all rules set by NUS IT. 
...
```{admonition} NUS IT
:class: tip, dropdown
NUS IT provides support for IT related issues. They also provide services such as HPC and server hosting. You can submit a ticket on A.S.K. if you have any issues related to IT.
...
- [IT Care](https://nusit.nus.edu.sg/itcare/) and [A.S.K.](https://ask.nus.edu.sg/)
- [NUS HPC](https://nusit.nus.edu.sg/hpc/)
```

## Security
### Back up your data regularly
You must have a backup of your most important data on a cloud drive (OneDrive) or other reliable storage media. The best practice is following to 3-2-1 rule: 3 copies (including to original data), 2 different media, and 1 off-site backup copy.
...
- Setup to two(multi)-factor-authentication (2FA) for all of your account as possible.
...
```{admonition} Passkeys
:class: tip, dropdown
You can use [Passkeys](https://developers.google.com/identity/passkeys) to login passwordless to reduce to risk of password leaking from incidence such as data breaching. This function is available in most password managers, but it needs support from remote machine as well. Currently, most big service providers supports Passkeys: Github, Google, Microsoft, Apple, and Amazon.
```

## Searching & managing literature
You should use [Find Full Text: Proxy Bookmarklet](https://libguides.nus.edu.sg/findfulltext/proxybookmark) for accessing literature. For reference management, we use Zotero and you can find a guide for Zotero by [NUS Library](https://libguides.nus.edu.sg/referencemanagement/zotero).
