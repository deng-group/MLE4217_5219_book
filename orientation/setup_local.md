...
:class: note
This section covers how to setup your local programming environment. We can access Vanda machine provided by the NUS HPC for free. You can follow the [Vanda setup instruction](setup_hpc.md) to set up your programming environment on Vanda. However, you may want to set up your local programming environment as well for convenience.
```
